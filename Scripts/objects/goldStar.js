...
var objects;
(function (objects) {
    var GoldStar = /** @class */ (function (_super) {
        __extends(GoldStar, _super);
        /**
         * Creates an instance of Gold Star.
         * @memberof GoldStar
         */
        function GoldStar() {
            var _this = _super.call(this, "gold_star") || this;
            _this.Start();
            return _this;
        }
        // private methods
        GoldStar.prototype._checkBounds = function () {
        ...
        // public methods
        GoldStar.prototype.Start = function () {
            this.regX = this.width;
            this.regY = this.height;
            this.Reset();
        };
        GoldStar.prototype.Update = function () {
            //this.y += this._verticalSpeed;
            this.x -= this._horizontalSpeed;
            this._checkBounds();
        };
        GoldStar.prototype.Reset = function () {
    ...
    objects.GoldStar = GoldStar;
})(objects || (objects = {}));
//# sourceMappingURL=goldStar.js.map